 ...
 *
 * Your StreamPay publishable [API key](https://docs.streampayments.org/keys) is required when calling this function, as it identifies your website to StreamPay.
 *
 * When you’re ready to accept live payments, replace the test key with your live key in production.
 * Learn more about how API keys work in [test mode and live mode](https://docs.streampayments.org/dashboard#viewing-test-data).
 */
